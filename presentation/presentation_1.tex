...
\begin{frame}[plain,noframenumbering]
        ...
        \begin{figure}
            \includegraphics[width=0.7\linewidth]{/home/nd/cloud/viva_prep/vanilla-ssm-inference/Hamming-distance-vanilla.pdf}
            \caption{hello}
        \end{figure}
\end{frame}
...
\begin{frame}[plain,noframenumbering]
        ...
        \begin{figure}
            \includegraphics[width=0.6\linewidth]{/home/nd/cloud/viva_prep/vanilla-ssm-inference/state-cardinality-vanilla.pdf}
            \caption{hello}
        \end{figure}
\end{frame}
