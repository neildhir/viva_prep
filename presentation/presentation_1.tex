...
\begin{frame}[plain]
    ...
    \begin{columns}[t] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
        ...
        \begin{figure}[ht]
            \subfloat[Parents]{\includegraphics[width=.7\textwidth]{figures/parents.jpg}}\\[-0em]
        \end{figure}
    \end{columns}
\end{frame}
...
\begin{frame}[plain]
    ...
    \begin{columns}[t] 
        ...
        \begin{figure}
            \centering
            \includegraphics[width=1\textwidth]{figures/MLDA.png}
...
\begin{frame}[plain,noframenumbering]
    ...
    \begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
        ...
        \column{.4\textwidth}
        \begin{figure}[ht!]
            \includegraphics[width=1.0\linewidth]{figures/hmm-anglican.png}
...
%\begin{itemize}
%    \item HDP-HMM
%    \item Lightweight modifications: sticky and stateful HDP-HMM to encourage state persistence
%    \item IDHMM, a novel BNP version of HSMM with non-parametric treatment of state and duration distributions
%\end{itemize}
...
\begin{frame}[plain,noframenumbering]
    ...
    % 13:29:15 cool stuff: drinkin
    \begin{figure}
        \centering
        \includegraphics[width=0.3\linewidth]{figures/speaker.png}
    \end{figure}
...
\begin{frame}[plain,noframenumbering]
    ...
    \begin{figure}
        \includegraphics[width=\linewidth]{figures/new-main-plot.pdf}
